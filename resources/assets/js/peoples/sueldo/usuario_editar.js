    ...
    methods: {
        ...
        */
        inicializar() {
            ...
            let uri2 = `/sueldo_item/${
                this.$route.params.id
                }`;


            this.axios.get(uri2).then(response => {
                this.itemEnviar.nombre=response.data.nombre;
                this.itemEnviar.idPersona=response.data.idPersona;
                this.itemEnviar.password=response.data.password;
