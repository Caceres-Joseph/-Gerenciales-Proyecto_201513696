    ...
    <v-container fluid>
        ...
        <v-dialog max-width="500px" v-model="dialog">
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn @click.native="eliminar" color="orange darken-4" dark>Eliminar</v-btn>
        ...
        <v-dialog max-width="500px" v-model="dialogNuevo">
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn @click.native="insertar" color="orange darken-4" dark>Aceptar</v-btn>
        ...
        <v-dialog max-width="500px" v-model="dialogModificar">
            <v-card color="grey lighten-3">
                <v-card-title>
                    <span class="headline">Modificar categoría</span>
                </v-card-title>
                <v-card-text>
                    <v-flex xs12>
                        <v-text-field
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn @click.native="modificar" color="orange darken-4" dark>Aceptar</v-btn>
        ...
        <!-- Filtro  -->
        <v-card-title>
            <h3 class="grey--text hidden-xs-only">Categorías</h3><br>
            <v-spacer></v-spacer>
            <v-text-field
                    append-icon="search"
                    hide-details
