  ...
  <v-container fluid>
    ...
    <v-card color="grey lighten-3">
      <v-card-title>
        <v-layout row wrap> 
            <v-flex xs12>
                <span class="headline">Devoluciones</span> 
            </v-flex>
        </v-layout>
      </v-card-title>
        <v-card-text>
            <v-layout row wrap> 
                ...
                <v-flex xs12>
                    ...
                    <template slot="items" slot-scope="props">
                        ...
                        <td class="text-xs-left"> {{ props.item.cajero }}</td>
                        <td class="text-xs-left"> {{ props.item.fecha_horaAgregada }}</td>
                        <td class="text-xs-left"> {{ props.item.idCajaAceptar }}</td>
                        <td class="text-xs-left"> {{ props.item.cajeroAceptar }}</td>
                        <td class="text-xs-left"> {{ props.item.fecha_horaAceptada }}</td> 
