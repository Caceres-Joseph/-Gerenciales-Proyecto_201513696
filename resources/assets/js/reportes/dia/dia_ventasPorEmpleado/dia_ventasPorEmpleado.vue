  ...
  <v-container fluid>
    ...
    <v-card color="grey lighten-3">
      <v-card-title>
        <v-layout row wrap> 
            <v-flex xs12>
                <span class="headline">Reporte diario de Ventas por Empleado</span> 
            </v-flex>
        </v-layout>
      </v-card-title>
        <v-card-text>
                            ...
                            <v-flex xs12 md4>
                                ...
                                <v-card-text>
                                    <v-layout row wrap>  
                                        ...
                                        <span class="title" >Q{{(this.mostrar.subTotal).toFixed(2)}} </span>
                                        </v-flex>
                                        <v-flex  xs6>
                                        ...
                                        <v-spacer></v-spacer>
                                        <v-flex xs6 class="text-xs-right">
                                        <span class="title" >Q{{(this.mostrar.propina).toFixed(2)}} </span>
                                        </v-flex>
...
<script src ="./dia_ventasPorEmpleado.js">