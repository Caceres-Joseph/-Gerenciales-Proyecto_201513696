  ...
  <v-container fluid>
    ...
    <v-card color="grey lighten-3">
      <v-card-title>
        <v-layout row wrap> 
            <v-flex xs12>
                <span class="headline">Reporte general de Ordenes</span> 
            </v-flex>
        </v-layout>
      </v-card-title>
        <v-card-text>
            <v-layout row wrap> 
                            ...
                            <v-flex xs12 md4>
                                ...
                                <v-card-text>
                                    <v-layout row wrap>  
                                        ...
                                        <v-flex  xs6>
                                        <span class="subheading"  > Num. de Ordenes: </span> 
                                        </v-flex>
                                        <v-spacer></v-spacer>
                ...
                <v-flex xs12>
                    ...
                    <template slot="items" slot-scope="props">
                        ...
                        <td v-if="!props.item.eliminado" class="text-xs-left">  Si</td>
                        <td v-else class="text-xs-left">No</td>

                        <td v-if="props.item.cancelado" class="text-xs-left">  Si</td>
                        <td v-else class="text-xs-left">No</td>

                        <td v-if="!props.item.cuarentena" class="text-xs-left">  Si</td>
                        <td v-else class="text-xs-left">No</td>

                        <td v-if="props.item.devolucion" class="text-xs-left">  Si</td>
                        <td v-else class="text-xs-left">No</td>
...
<script src ="./dia_ordenesGeneral.js">