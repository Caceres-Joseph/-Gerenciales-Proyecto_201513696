    ...
    methods: {
        ...
        */
        ...
        clckAceptar() {
            ...
            let uri = this.ip + "inventario_getMovimientoDeLaSemana";
        ...
        clckDlgAceptar() {
            ...
            let uri = this.ip + "inventario_insertItems";
        ...
        clckInventarioAnterior() {
            ...
            let uri = this.ip + "detalleInventario_getItemsInvAnte";
            this.axios.post(uri, enviar).then(response => {
        ...
        clckDlgAceptarFraccion() {
            ...
            if (e.denominator == "0") {
                ...
                var ele = math.eval(e.entero+"+"+e.numerator+"/"+e.denominator)   // Fraction, 2/5
